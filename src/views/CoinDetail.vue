  ...
  <div class="flex-col">
    ...
    <template v-if="!isLoading">
      <div class="flex flex-col sm:flex-row justify-around items-center">
        <div class="flex flex-col items-center">
          <img
            ...
            :src="`https://static.coincap.io/assets/icons/${asset.symbol.toLowerCase()}@2x.png`" alt="asset.name"/>
          <h1 class="text-5xl">
            {{asset.name}}
      ...
      <line-chart class="my-10" 
        ...
        <h3 class="text-xl my-10 flex justify-center">Mejores ofertas de Cambio </h3>
        <div class="flex justify-center">
        <table>
